...
export default async function ComposerDetailsPage({
  ...
  if (!artist.is_composer) return notFound();
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12">
      ...
      <div className="text-center text-gray-700">
        {/* 🔜 Placeholder for composer-related content (movies, songs, etc.) */}
        <p className="italic text-gray-400">Composer details coming soon...</p>
      </div>
    </div>
  );
}
